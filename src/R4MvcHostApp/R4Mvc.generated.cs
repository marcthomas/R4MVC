...
namespace R4MvcHostApp.Controllers
{
    ...
    public partial class R4MVC_AccountController
    {
        ...
        [GeneratedCode("R4MVC", "1.0")]
        public readonly string Name = "R4MVC_AccountController";
        [GeneratedCode("R4MVC", "1.0")]
        public const string NameConst = "R4MVC_AccountController";
        [GeneratedCode("R4MVC", "1.0")]
        public readonly string Area = "R4MVC_AccountController";
        static readonly ActionNamesClass s_actions = new ActionNamesClass();
        [GeneratedCode("R4MVC", "1.0"), DebuggerNonUserCode]
        public class ActionNamesClass
        {
    ...
    [GeneratedCode("R4MVC", "1.0"), DebuggerNonUserCode]
    public partial class R4MVC_R4MVC_AccountController : R4MvcHostApp.Controllers.R4MVC_AccountController
    {
        public R4MVC_R4MVC_AccountController()
        {
        }
    }
    ...
    public partial class R4MVC_HomeController
    {
        ...
        [GeneratedCode("R4MVC", "1.0")]
        public readonly string Name = "R4MVC_HomeController";
        [GeneratedCode("R4MVC", "1.0")]
        public const string NameConst = "R4MVC_HomeController";
        [GeneratedCode("R4MVC", "1.0")]
        public readonly string Area = "R4MVC_HomeController";
        static readonly ActionNamesClass s_actions = new ActionNamesClass();
        [GeneratedCode("R4MVC", "1.0"), DebuggerNonUserCode]
        public class ActionNamesClass
        {
    ...
    [GeneratedCode("R4MVC", "1.0"), DebuggerNonUserCode]
    public partial class R4MVC_R4MVC_HomeController : R4MvcHostApp.Controllers.R4MVC_HomeController
    {
        public R4MVC_R4MVC_HomeController()
        {
        }
    }
